 ...
 */
public class StudentVaryingParametersDistributionStrategy extends AbstractVaryingParameterDistributionStrategy {
    ...
    public IParameterObjectClassifier getType() {
        return VaryingParametersDistributionType.STUDENTDIST;
    }
    ...
    protected TreeMap<Integer, RandomDistribution> initDistributions() {
        ...
        for (int row = n.getTitleRowCount(); row < n.getRowCount(); row++) {
            ...
            distributionPerPeriod.put(period, (RandomDistribution) VaryingParametersDistributionType.getStrategy(
                    VaryingParametersDistributionType.STUDENTDIST, ArrayUtils.toMap(
